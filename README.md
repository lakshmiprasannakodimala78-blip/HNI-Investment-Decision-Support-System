...
## Project Overview
This project is a Minimum Viable Product (MVP) designed to support High Networth Individuals (HNIs)
in making informed investment decisions using financial data analysis, classification, and scoring models.
